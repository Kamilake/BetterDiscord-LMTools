...
export const EXAMPLE_PROMPTS = {
  technical: `Below is a Discord chat conversation. Please summarize this conversation concisely and clearly in Korean:
...
\`\`\``,
  ...
  default: `Below is a Discord chat conversation. Please summarize this conversation concisely and clearly in Korean:
...
\`\`\``,
  ...
  casual: `Below is a Discord chat conversation. Please summarize this conversation concisely and clearly in Korean:
